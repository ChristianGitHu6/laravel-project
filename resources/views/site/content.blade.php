		      ...
		      <div class="hero_section">
		        <div class="row">
		          ...
		          <div class="col-lg-7 col-sm-5">
		          	<!-- HTML&FORMS   tex@ nshumenk ev verjum databaseic 
		          		vercnumenk tvyal $page - img@ -->
    ...
    <div class="service_wrapper">
		...
		@foreach($services as $k=>$service)
			...
			@endif
       		 ...
       		 <div class="col-lg-4 {{ ($k%3 > 0) ? 'borderLeft' : '' }} {{ ($k > 2) ? 'mrgTop' : '0' }}">
        ...
        <div class="col-lg-8 wow fadeInLeft delay-06s">
          <div class="form">
          	...
          	<form action="{{route('home')}}" method="post">
		            ...
		            <textarea class="input-text text-area"  name="text" placeholder="Your Message" cols="0" rows="0" ></textarea>
